package br.edu.ifpb.pweb2.sistema.aluno.filter;
...
@WebFilter(filterName = "LoginFilter", urlPatterns= {"/aluno/*", "/falta/*"})
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (httpSession != null) {
			Usuario login = (Usuario) httpSession.getAttribute("usuarioLogado");
